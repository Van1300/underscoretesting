...
const testJSON = require('../../pageobjects/standardPageobjects/Table1/table1List.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/Table1/table1List.json');
const mockData = require('../../mockData/Table1/table1Listmockdata.json')
