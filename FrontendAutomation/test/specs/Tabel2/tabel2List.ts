...
const testJSON = require('../../pageobjects/standardPageobjects/Tabel2/tabel2List.json');
const testCustomJSON = require('../../pageobjects/customPageobjects/Tabel2/tabel2List.json');
const mockData = require('../../mockData/Tabel2/tabel2Listmockdata.json')
