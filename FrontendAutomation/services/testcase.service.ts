...
class testcaseService {
  ...
  async executeEachTestCases(testCase: any, callback: any, lastTestCasename: any) {
    await this.iterateTestCases(testCase.actionBefore, callback, lastTestCasename);
    ...
    await this.iterateTestCases(testCase.actionAfter, callback, lastTestCasename);

    await browser.pause(500);
  }

  async createMockupRecord(reqParam: any, cookie: any, mockDataRes: any) {
  ...
  async deleteMockupRecord(url: any, param: any, cookie: any) {
    //console.log('DELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETEDELETE', url + '/' + param)
