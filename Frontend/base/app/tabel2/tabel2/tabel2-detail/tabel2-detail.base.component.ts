...
import { Tabel2Base} from '../tabel2.base.model';
...
import { Tabel2ApiConstants } from '@baseapp/tabel2/tabel2/tabel2.api-constants';
...
export class Tabel2DetailBaseComponent{
...
currentUserData:any;
selectedItems:any ={};
workflowType = "blanks_name";
workFlowEnabled = true;
workFlowInitialState = "OPEN";
workFlowField = "field1";
workflowActions:any ={
    disableActions:[],
    enableActions:[],
    hideActions:[]
 ...
 queryParams:any ={};
  ...
  "children" : [ {
    ...
    "children" : [ {
      ...
      "showOn" : "both",
      "enableOnlyIfRecordSelected" : false,
      "buttonId" : "WorkflowhistorybuttonId3",
      "buttonEnabled" : "yes",
  ...
  "children" : [ {
    ...
    "children" : [ {
      "visibility" : "show",
      "buttonStyle" : "curved",
      "methodName" : "triggerWebserviceCreateopentab2blanksNameCreateopentab2",
      "label" : "CREATEOPENTAB2",
      "type" : "button",
      "outline" : true,
      "buttonType" : "icon_on_left",
      "service" : {
        "sid" : "c99afe13-19d3-40c8-b0f8-926441898452",
        "name" : "blanksNameCreateopentab2",
        "tableName" : "tabel2",
        "tableId" : "6457d3f1-69fc-44cc-916c-16a20a12d5ea"
      },
      "showOn" : "both",
      "enableOnlyIfRecordSelected" : false,
      "buttonId" : "Createopentab2buttonId0",
      "buttonEnabled" : "yes",
      "action" : "call_a_backend_webservice",
      "fields" : [ ],
      "wfAction" : "createopentab2"
    } ],
    "buttonStyle" : "curved",
    "displayCount" : "2",
    "label" : "BUTTON_GROUP",
  ...
  "queryViewMapping" : { }
	...
	pageViewTitle: string = 'TABEL2_DETAIL';
	
	public tabel2Service = inject(Tabel2Service);
...
public location = inject(Location);
	...
	field2: new UntypedFormControl('',[Validators.required]),
    ...
    let action: Exclude<keyof Tabel2DetailBaseComponent, ' '> = methodName;
...
addValidations(mandatoryFields:[]){
	...
	triggerWebserviceCreateopentab2blanksNameCreateopentab2() {
    const params = this.getInputParams();
    this.tabel2Service.blanksNameCreateopentab2(params).subscribe({
          next: res => this.manipulateOutputData(res),
 ...
 getRoleShortName(currentUserData:any){
  ...
  camelize(str: string) {
	...
	editFormula(config:any,fieldname:any){
         ...
         if(fieldConfig.formulaMethod){
           let methodName: Exclude<keyof Tabel2DetailBaseComponent, ' '> = fieldConfig.formulaMethod
  ...
  if (environment.prototype && this.id) {
    ...
    this.tabel2Service.getProtoTypingDataById(params).subscribe((res: any) => {
    ...
    const params = {
      ...
      const dataSubscription = combineLatest(this.tabel2Service.getById(params), this.appBaseService.getWorkFlowConfig(wfParams)).subscribe((res: any) => {
          this.data = res[0] || {};
          this.securityJson = res[1];
          this.getListofServicesTobeFired().subscribe((responses: any[]) => {
              this.formatRawData();
            });
          this.configureFormOnWorkflow(this.data?.workflowInfo);
        });
    ...
    if (this.checkValidations()) {
      ...
      if (Object.keys(splittedData.files).length > 0) {
        ...
        const saveSubscription = this.tabel2Service[method](requestedObj, actionName).subscribe((res: Tabel2Base) => {
          this.onAfterSave(res, data, method, isToastNotNeeded);
        })
        this.subscriptions.push(saveSubscription);
      }
...
uploadAttachmentsandSaveData(data: any, splittedData: any,actionName?:string): Observable<any> {
    ...
    if (!this.id) {
       const saveSubscription =  this.tabel2Service.create(splittedData.data,actionName).subscribe(
        createdData => {
    ...
    const subject$ = new Subject();    
      const updateSubscription = this.deleteFiles(splittedData).subscribe((responseData: any) => {
        this.saveFiles(responseData).subscribe((dataToUpdate: any) => {
          ...
          this.tabel2Service.update(dataToUpdate.data,actionName).subscribe(
            res => {
              subject$.next(res);
              subject$.complete();
            },
...
saveFiles(splittedData: any) {
  ...
  mergeExistingFiles(newobj: any, oldobj: any) {
	...
	this.tabel2Service.blanksNameCreateopentab2(params).subscribe((res:any)=>{
