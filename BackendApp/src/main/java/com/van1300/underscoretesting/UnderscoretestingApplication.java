package com.van1300.underscoretesting;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.van1300.underscoretesting"})
@EnableCaching
...
public class UnderscoretestingApplication {

	public static void main(String[] args) {
		SpringApplication.run(UnderscoretestingApplication.class, args);
	}
